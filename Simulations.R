...
sim_data <- function(n, N, C, n_star, true_rho = NULL, true_A_star = NULL, top_rank = 0, consistency = 0, alpha_true = 3){
  C <- top_rank + consistency
...
#### Function for generating random initialization
generate_random_init <- function(M,N,n,C,n_star, thinning = 10){
